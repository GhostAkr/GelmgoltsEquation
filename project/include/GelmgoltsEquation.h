...
// Main
void Zeidel(double** _mesh, int _rows, int _cols, double _k, double _step);  // TODO: make Zeidel
void Jacobi(double** _mesh, int _rows, int _cols, double _k, double _step);  // TODO: make Jacobi
